...
if page == "Genre Distribution":
    ...
    fig_votes = px.histogram(df, x='votes', nbins=30, title='Distribution of Votes', color_discrete_sequence=['blue'])
    st.plotly_chart(fig_votes, use_container_width=True)

    st.subheader("Distribution of Ratings")
    fig_ratings = px.histogram(df, x='rating', nbins=30, title='Distribution of Ratings', color_discrete_sequence=['blue'])
